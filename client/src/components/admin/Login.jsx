    ...
    <div className='flex items-center justify-center h-screen'>
        <div className='w-full max-w-sm p-6 max-md:m-6 border border-primary/30 shadow-xl shadow-primary/15 rounded-lg'>
            ...
            <div className='w-full py-6 text-center'>
                ...
                <p className='font-bold'>Enter your credentials to access the admin panel</p>
            </div>
            ...
            <button type ="submit" className='w-full py-3 font-medium bg-primary text-white cursor-pointer hover:bg-primary/90 transition-all'> Login </button>
            </form>
            </div>
        </div>
    </div>
